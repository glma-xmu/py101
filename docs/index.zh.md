...
本课程是使用 Python 进行程序设计的全面入门课程，重点关注**人工智能**方向的应用。本站为中英双语 —— 可使用顶部的**语言切换**按钮在 English 与中文之间切换。
...
- [🎙️ 课堂实时翻译（英文 → 中文）](live_translator.html) —— 为英文授课提供实时字幕，全部在你的浏览器本地运行。在授课电脑上打开它，点击 *Start*，再把中文字幕投影出来。

---

© 2025–2026 **马国良（Guoliang Ma）** · 保留所有权利。使用条款详见[版权声明](copyright.md)页面。
